		...
		exports.fn.gotoLineDialog = function() {
			...
			{			
				var dialogContent = [
					...
					"<p style=\"margin: 0;\">" + dialogLang.label + " 1-" + lineCount +"&nbsp;&nbsp;&nbsp;<input type=\"number\" class=\"number-input\" style=\"width: 60px;\" value=\"1\" max=\"" + lineCount + "\" min=\"1\" models-line-number /></p>",
					"</div>"
				].join("\n");
				...
				dialog = this.createDialog({
					...
					buttons    : {
                        enter : [lang.buttons.enter, function() {
							var line   = parseInt(this.find("[models-line-number]").val());
