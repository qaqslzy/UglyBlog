		...
		exports.fn.referenceLinkDialog = function() {
            ...
            {      
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" +
                                        ...
                                        "<input type=\"text\" value=\"[" + ReLinkId + "]\" models-name />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlId + "</label>" +
                                        "<input type=\"text\" models-url-id />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.url + "</label>" +
                                        "<input type=\"text\" value=\"http://\" models-url />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlTitle + "</label>" +
                                        "<input type=\"text\" value=\"" + selection + "\" models-title />" +
                                        "<br/>" +
                                    "</div>";
                ...
                dialog = this.createDialog({   
                    ...
                    buttons : {
                        enter  : [lang.buttons.enter, function() {
                            var name  = this.find("[models-name]").val();
                            var url   = this.find("[models-url]").val();
                            var rid   = this.find("[models-url-id]").val();
                            var title = this.find("[models-title]").val();
			...
			dialog.find("[models-name]").val("[" + ReLinkId + "]");
			dialog.find("[models-url-id]").val("");
			dialog.find("[models-url]").val("http://");
			dialog.find("[models-title]").val(selection);
