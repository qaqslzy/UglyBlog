...
(function(mod) {
  ...
  // Updates the display.view models structure for a given change to the
  ...
  function onDragStart(cm, e) {
    ...
    if (e.dataTransfer.setDragImage && !safari) {
      ...
      img.src = "models:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";
      if (presto) {
  ...
  // Perform a change on the document models structure.
